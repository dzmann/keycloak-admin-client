...
//        // Assign realm role tester to user
        ...
        ClientRepresentation app1Client = realmResource.clients().findByClientId("study-keycloak").get(0);
...
//        userResource.remove();
        ...
        System.out.println(mapper.writeValueAsString(realmResource.users().get(userId).toRepresentation()));
